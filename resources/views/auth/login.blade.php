...
@section('auth-body')
    <div class="limiter">
        <div class="container-login100" style="background-image: url( '{{ asset('public/asset/layout/images/banner.jpg') }}');">
            <div class="wrap-login100" style="background-color: #0cbb06">
