            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <form class="form" id="form_validation" method="post" action="{{ route('report.sells.party_ledger.customer_wise')  }}">

                                {{ csrf_field() }}
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select data-live-search="true" class="form-control show-tick" name="customer_id">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select id="product_id" data-live-search="true" class="form-control show-tick" name="product_id">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-line">
                                        <input formtarget="_blank" name="action" value="Show" type="submit" class="btn btn-primary m-t-15 waves-effect">
                                        <input name="action" value="Pdf" type="submit" class="btn btn-primary m-t-15 waves-effect">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <form class="form" id="form_validation" method="post" action="{{ route('report.sells.party_ledger.summary_wise')  }}">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-line">
                                        ...
                                        <input name="action" value="Excel" type="submit" class="btn btn-primary m-t-15 waves-effect">
                                    </div>
                                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <form class="form" id="form_validation" method="post" action="{{ route('report.sells.party_ledger.seller_name_wise') }}">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select data-live-search="true" class="form-control show-tick" name="employee_id">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <form class="form" id="form_validation" method="post" action="{{ route('report.sells.party_ledger.day_wise') }}">
                                {{ csrf_field() }}

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="input-daterange input-group" id="bs_datepicker_range_container3">
                                        <div class="form-line">
                                            <input autocomplete="off" name="from" type="text" class="form-control" placeholder="Date start..." value="{{ date('m/d/Y')}}" min="{{ date('m/d/Y')}}" max="{{ date('m/d/Y')}}">
                                        </div>
                                        <span class="input-group-addon">to</span>
                                        <div class="form-line">
                                            <input autocomplete="off" name="to" type="text" class="form-control" placeholder="Date end..." value="{{ date('m/d/Y')}}" min="{{ date('m/d/Y')}}" max="{{ date('m/d/Y')}}">
                                        </div>
                                    </div>
                                </div>
...
<link href="{{ asset('public/asset/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') }}" rel="stylesheet" />
