                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        ...
                                        @foreach($items as $item)
                                            <tr>
                                                ...
                                                @php
                                                    $d = \DB::table('directors')->where('user_id',$item->director_id)->first();
                                                    $d_name = (!empty($d)) ? $d->name : "N/A";
                                                @endphp
                                                <td>{{ $d_name}}</td>
                                                ...
                                                <td class="tdTrashAction">
                                                    ...
                                                    <a @if ($delete==0)
                                                       ...
                                                       data-toggle="tooltip"
                                                       data-placement="top" title="Sales Return"> <i class="material-icons">keyboard_return</i></a>
                                                    ...
                                                    <a @if ($pdf==0)
                                                       ...
                                                       data-toggle="tooltip"
                                                       data-placement="top" title="Schedule Manage"> <i
