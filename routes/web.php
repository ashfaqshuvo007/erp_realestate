...
//    profile
    ...
    //manage Directors
    Route::get('/user/manage_directors', [
        'uses' => 'UsersController@manage_directors',
        'as' => 'user.manage_directors',
    ]);

    Route::get('/user/director/edit/{id}', [
        'uses' => 'UsersController@edit_director',
        'as' => 'user.edit_director',
    ]);

    Route::post('/user/director/update/{id}', [
        'uses' => 'UsersController@update_director',
...
//    General Report End
    ...
    Route::post('report/sells/party-ledger/sells_day_wise', [
        'uses' => 'Reports\Sells\SellsReportController@day_wise',
        'as' => 'report.sells.party_ledger.day_wise',
    ])->middleware('sells_report.all');
